...
<body>
  ...
  <section id="wrapper">
    ...
    <div class="p-4">
      ...
      <h1 style="color: white">Purchases</h1>
      <div class="container">
        <form method="post" enctype="multipart/form-data" action="purchase.php">
          ...
          <div class="input-pair">
            ...
            <select id="reason" name="reason" required style="padding: 5px;">
          ...
          <div class="input-pair">
            <label for="bill_pdf">Bill PDF:</label>
            <input type="file" id="bill_pdf" name="bill_pdf" accept=".pdf,image/*">
          </div>
