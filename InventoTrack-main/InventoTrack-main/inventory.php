...
<body>
    ...
    <section id="wrapper">
        <nav class="navbar navbar-expand-md">
            ...
            <a class="nav-link" href="#"><i class="uil-user-circle" style="font-size: 24px;"></i></a> -->
        ...
        <div class="p-4">
                ...
                <form method="post" style="width:100%">
                    <div class="search-bar">
                        <input type="text" class="search-input" name="search"
                            placeholder="Search for products (ID, Name, Description, Price, Quantity, Dealer, Date)"
                            style="width:100%">
            ...
            <h1 style="color:white; margin-top:20px">All Products</h1>
    ...
    <script>
                ...
                $sql = "SELECT * FROM product WHERE product_quantity > 0 AND (product_name LIKE '%$searchTerm%' OR product_description LIKE '%$searchTerm%' OR product_id LIKE '%$searchTerm%' OR product_price LIKE '%$searchTerm%' OR date LIKE '%$searchTerm%' OR dealer_name LIKE '%$searchTerm%' OR product_quantity LIKE '%$searchTerm%')";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<button type="submit" name="delete" style="background:red; color:white; padding: 0px 10px; border-radius:5px; font-size:15px">Delete</button>';
